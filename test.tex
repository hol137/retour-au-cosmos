...
Le modèle dit du Big-Bang est une description de l'origine et de l'évolution de l’Univers datant du début du 20ème siècle.
...
\subsubsection{la question de l'anti-matière}
   Selon le modèle standard le Big Bang aurait dû doner naissance à autant de matière que d'anti-matière. Or cette anti-matière ne se manifeste nulle part dans l'Univers. C'est ainsi que le cosmologue Jean-Pierre Petit a titré justement un ouvrange ``On a perdu la moitié de l'Univers''. Le modèle standard des particules a été appelé à la \textcolor{red}{escousse} pour déceler une lègère dissymétrie entre particules et anti-particules pour justifier de l'anéantissement de ces dernières, mais sans succès.
...
il était membre du Comité de parrainage.
...
Mais cela ne découragea pas les formalistes et les logiciens, qui finirent par vouloir introduire le formalisme dans l'enseignement des mathématiques modernes, avec les conséquences désastreuses que l'on sait. 
...
Ces 10 colonnes sont séparées en deux rangées de 5 par ``l'axe divin'' de symétrie générale de la salle, tandis qu'un ``axe royal'' sépare de chaque coté les 5 en 3 plus 2.  Or \textcolor{red}{deux} colonnes super-géantes supplémentaires sont a demi-immergée dans la paroi, de chaque coté. Cela illustre le fait que 6 – 1 = 5 = 2 + 3, où on trouve la somme des diviseurs de 6. \textit{C'est la définition d'un nombre parfait dont 6 est l'archétype}.
      ...
      De plus les colonnes latérales sont rangées par rangs de 7, ce qui illustre ce nombre de Mersenne comme étant 8 moins 1, cette unité étant representée par \textcolor{red}{une/deux} des super-colonnes centrales.
      

L'histoire raconte que le Pharaon venait méditer au croisement des 2 axes, comme si les prêtres avaient deviné que le terme suivant définissait l'univers. \textit{Ils en savaient donc plus que notre siècle de faux scientifiques qui ont oublié le Cosmos}.
...
\subsubsection{Il fallait des astronomes bien formés à la méthode scientifique.}
 ...
 Son aide, Milton Humason, était au départ le muletier qui assurait le ravitaillement. Il a  été promu astronome de classe mondiale.
...
Ensuite, il a été décrété que le temps des découvreurs isolés était révolu, donc les revues scientifiques principales ne publient que les articles provenant de laboratoires prestigieux. Tout chercheur doit donc s’intégrer dans une équipe de recherche. 
...
\textit {Les chercheurs censurent donc les trouveurs}. C'est ce que ne pouvait comprendre le politicien qui déclarait ``les chercheurs on en trouve, les trouveurs on en cherche''.
...
Vers 2014, les mesures de la constante de Newton G étaient contradictoires. Les plages d’incertitude des mesures des différents laboratoires ne se recouvraient pas, elles ne convergeaient pas vers une valeur précise, voir la figure \ref{fig:8:figure8} \cite{Wu}.
...
La suite était prévisible : plusieurs laboratoires ont confirmés cette valeur. Le chapitre 8 indique la bonne valeur, qui est compatible avec les mesures plus sérieuses, celles de Terry Quinn au BIPM \cite{Quinn}. Mais la domination américaine a encore frappé, et ces mesures furent purement et simplement oubliées, tout en reconnaissant officiellement qu’on ignore d’où vient l’erreur.
...
Nous avons montré que, une fois de plus, c'est la loi du plus simple qui prévaut, puisque \textit{l'analyse dimensionnelle ternaire M,L,T, donne la longueur critique, le demi-rayon de Hubble\cite{Maruani}}. Mais Okun commet l'erreur fatale d'identifier le nombre d'entités fondamentales avec celui des grandeurs fondamentales. Ainsi il ne considére pas la masse de l'électron comme une grandeur universelle.
...
C'est ainsi que s'applique la phrase prémonitoire d'Augustin Fresnel, \textit{"Quand une hypothèse est vraie, elle doit conduire à la découverte de rapports numériques qui lient entre eux les faits les plus éloignés".} 
...
Le Cosmos ne peut être que la plus belle des structures. Or que constate-t-on chez l'enfant ? : il pose sponanément des questions. L'humain est donc fondamentalement un chercheur : la résolution des problèmes le fascine. Le Cosmos est donc aussi un chercheur, qui s'équipe d'humains pour optimiser sa quête, comme un ordinateur s'entoure de périphériques.

Voilà la réponse à la plus fondamentale des questions "pourquoi posons-nous des questions ?' Blaise Pascal avait repéré ce fait que l'humain est caractérisé par le questionnement.
...
\item \textbf{Antimatière}(re-définition): matière qui oscille en opposition de phase avec la matière environnante (voir  \textcolor{blue}{antiparticule})
...
\item \textbf{Black Hole}: \textcolor{red}{voir Trou noir}
...
\item \textbf{Constante de Hubble}: \textcolor{red}{definition de la constante de Hubble $H_0$, p31 chap 5.0.7}

\item \textbf{Cosmologie cohérente} (néologisme) : cosmologie où tous les Univers particulaires sont équivalents. S’oppose au Multivers disparate officiel qui attribue des propriétés différentes à une série indéfinie et non observable d’univers. \textcolor{red}{definition peu claire et incomplete}
...
\item \textbf{Permanent Big bang}: \textcolor{blue}{definition manquante}
...
\item \textbf{Rayon de Schwarzschild}: \textcolor{blue}{definition manquante}
...
\item \textbf{Trou blanc}: \textcolor{blue}{definition manquante}
...
\bibitem{Grosmann4} Jean-Claude Chaimowicz, Michel Grosmann: ``Introduction a l'optoelectronique : principes et mise en oeuvre'', Ed Dunod, 407p, isbn: 9782100012923.
\newblock {\em https://books.google.fr/books?id=M3KZHAAACAAJ}, 1992

\bibitem{Quinn} Quinn T, Speake C, Parks H, Davis R. 2014 The BIPM measurements of the Newtonian constant of gravitation, G. Phil.Trans. R. Soc. A372: 20140032. \\
\newblock {\em https://royalsocietypublishing.org/doi/10.1098/rsta.2014.0032}, 2014

\bibitem{Maruani} Jean Maruani. “The Dirac Electron: From Quantum Chemistry to Holistic Cosmology” in Journal of
the Chinese Chemical Society, vol.63 issue 1, Taipei, Wiley VCH Verlag GmbH, 2016, 33–48 p.
\newblock {\em https://doi.org/10.1002/jccs.201500374}, 2016
