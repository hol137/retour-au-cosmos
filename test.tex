...
\title{Retour vers le cosmos et Axe Topologique \emph{conference} preprint}
...
Voir Figure \ref{fig:figure_label}. Pour plus d'explications. \footnote{Sample of the first footnote.}
