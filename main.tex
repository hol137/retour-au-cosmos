...
Extrait de "L'Epopée des Millénaires " (Cinquième Millénaire )

... Il faut ici rappeler que, depuis des temps immémoriaux, les peuplades les plus primitives avaient inventé les dieux, attribuant ainsi une cause à chaque phénomène: c'était l'éclosion larvée d'une pensée scientifique, reléguant ainsi le hasard aux nimbes ténébreuses de l'inconscience. C'était alors une question de survie pour la tribu : il fallait agencer la chasse ou la cueillette suivant certaines époques et des règles précises. Mais des dieux vengeurs ou sournois pouvaient perturber cet équilibre fragile : il fallait donc apaiser leur courroux et s'attirer leur bonnes grâces en érigeant des monuments, lieux de multiples cérémonies et de sacrifices solennels. Ainsi, chaque soir, on priait le dieu Soleil de bien vouloir ressortir des ténèbres glacées où il avait disparu, libérant des esprits mauvais et des terreurs sans noms, qu'il fallait éviter en s'enfonçant au plus profond des cavernes.

En prévision des temps mauvais, il fallait stocker la nourriture, qu'il fallait répartir suivant les préséances, la part du lion revenant aux sorciers qui communiquaient directement avec les dieux. Ce fut l'origine de la notion de Nombre. Aussi, après chaque inondation du Nil, il fallait réaménager le terrain : ce fut l'origine de la Géométrie, que les prêtres-sorciers associèrent naturellement aux nombres et aux dieux. C'est pourquoi les premières pyramides avaient la pente 4/3, illustrant le fameux triangle rectangle géo-numérique 3-4-5. 

Ils érigèrent enfin la Grande Pyramide, qui est l'accomplissement le plus merveilleux entre le Nombre et la Géométrie. Mais les inconscients bornés de la Malscience ne réalisèrent pas que le périmètre de sa base, parfaitement carrée à la minute d'angle près, est égal, au millième près, avec la circonférence du cercle ayant sa hauteur comme rayon. Avec le temps, la pointe s'était erodée de plusieurs mètres, mais l'angle de sa pente est restée immuable : les 51 degré 50 minutes du triangle d'or, dont l'hypothénuse est dans le rapport doré avec le petit côté, le grand coté étant donc la hauteur de la pyramide, la racine dorée, voisine, comme chacun sait, de 4/pi, toujours au millième près.

Ce fut la première relation holographique de l'Histoire, mais, lors des temps maudits de la Malscience, elle fut attribuée au hasard par la Meute des Inconscients. Ces illuminés étaient incapables de distinguer un diamant dans une forêt de mauvais cailloux numérologiques. Ils s'étaient fortement soudés entre eux dans un consensus idéologique malsain où l'on vénérait ces concepts futiles d'infini et de hasard. Ils traitaient même de vieux fou l'Usurpateur qui se plaignait que Dieu puisse jouer au dés. Le combat était évidemment inégal avec l'Holesthète, car ils maitirisaient les média pour dompter les opinions, s'appuyant sur des travaux nombreux et prolixes vantant les mérites de la logique mathématique absconse la plus pointue. Ils s'appuyaient sur des travaux gigantesques, consignés dans des bibliothèques géantes et la Toile qui consacrait la Pensée Unique. Ils avaient bâti des machines prodigieuses, monument modernes destinées au boson scalaire, cette particule-divine dominatrice et tentaculaire, de qui l'on devait tenir l'origine même de la masse.

Oui, le combat était inégal,... ils n'avaient aucune chance.

 L'avènement des grands télescopes a mis fin à cette dérive anti-cosmique.
 
 

En ces temps reculés et maudits, les gens vénéraient des photons sans masse, libres et baladeurs qui voltigeaient en tous sens, en suivant les préceptes d'un usurpateur qui avait trahi les propos du valeureux Poincaré et qui avait interdit la route des étoiles, en ignorant le clignotement matière-antimatière, la clef de la trans-matérialisation. Ils croyaient dur comme fer que la charge électrique n'était pas un nombre pur quantique, comme la charge de couleur des quarks. Ils pensaient sincèrement que l'Univers avait un début et une histoire, et lui prévoyaient une fin horrible, dans le dénuement le plus complet. Ils avaient écarté le grand Eddington dont chacun admire le clairvoyant calcul du nombre de neutrons dans la partie baryonique complète, incluant la matière noire déphasée, de l'Univers c-observable. Comme ils avaient été jusqu'à adorer le Hasard pur, la Guilde Galactique avait recommandé d'éviter tout contact avec une telle non-civilisation, ne permettant seulement que des survols rapides et touristiques, car ce cas d'abrutissement était pratiquement unique dans la Galaxie. D'aucuns allaient jusqu'à regretter de ne pas avoir laissé leur chance aux dinosaures, et proposaient de projeter sur la planète un nouvel astéroïde dévastateur. Heureusement, l'Article du Millénaire a persuadé les Guildeurs que tout n'était pas encore totalement perdu sur cette malheureuse planète. 
PS. Surveillez de près les résultats des télescopes géants qui vont fouiller le fond de l'Univers, et préparez vous à une grande surprise : le retour du Cosmos !

On a peine à le croire, mais les historiens sont formels : en ces temps incertains et confus, les gens ont été tout surpris de constater que d'autres soleils possédaient des planètes, alors même que leur soleil exhibait un cortège planétaire très étendu et régulier. Influencés par des illuminés qui plaçaient le hasard comme causalité première, ils envoyaient des engins ridicules pour fouiller les décombres planétaires, mettant ainsi en question l'universalité de la vie. Il suffit pour cela d'examiner la structure atomique singulière de l'ADN : comme chacun sait c'est même un test décisif pour apprécier les aptitudes d'un robot primitif. Le comble, c'est que ces énergumènes étaient parcourus sans relâche par les touristes galactiques, qui bien que très discrets, conformément à la Charte Galactique, ne manquaient pas d'exhiber les performances de leurs cosmonefs, sans aucune comparaison avec les poussifs engins de ces malheureux. La réputation d'une telle anomalie civilisationnelle s'était répandue dans toute la Galaxie, et même au-delà, puisque même des Guildeurs d'Andromède en faisait la promotion.   

Il aut dire que les limites du grotesque avait été franchies quand ils avaient envoyé un engin indiquant leur anatomie et l'emplacement de leur soleil, par référence à des pulsars, comme si leur non-civilisation avait une quelconque importance, ce qui a beaucoup amusé les Guildeurs, et jusqu'à même, dit-on, les robots patrouilleurs qui ont récupéré l'engin. Celui-ci est maintenant exhibé dans le Musée Galactque d'Orion, parmi les bifaces, haches de pierre et autres instruments des pré-civilisations. Ceci pour l'éducation des jeunes, afin de montrer comment le rejet du Cosmos peut mal tourner.   



En ces temps perturbés et confus, les gens erraient dans l'indécision la plus totale. Certains vénéraient un illuminé antique, un certain Bouda, qui avait prôné de s'isoler dans la méditation, de se refermer sur soi-même, et de se passer ainsi de l'illumination cosmique qui exige un cheminement constant et prersévérant. A l'inverse, on prétendait très sérieusement démontrer l'absurdité du Monde, comme si cette assertion n'était pas en elle-même ridicule et stérile. Ces inconscients se lamentaient "pourquoi y a t il quelque chose plutôt que rien du tout". Comme si penser le néant n'était pas en soi-même une flagrante contradiction ? comme Descartes l'avait souligné. 

On rejettait l'idée même de vérité absolue, donc l'appel des Nombres était ignoré par la plupat des gens, et dont la beauté n'était perçue que par de rares initiés, qui étaient d'ailleurs fortement moqués par la nuée des malconscients, qui, précisément, prétendaient s'appuyer sur un subconscient facheux qui devait diriger tout. Bref, on était parvenu au pire chaos que l'humanité ait jamais connue. Même la musique, cet art céleste qui avair guidé les proto-humains par le chant des iseau, et avait fini par réglé les protocoles officiels, était remplacée par de vagues grognements et des rythmes barbares.
...
\caption [Mesures de la masse du Tau depuis 1978]{\textit{Mesure de la masse du Tau d'apres Particle Data Group 2019} - Tracé historique \cite{Tanabashi}.} 
\label{fig:7:figure7}
\end{figure}
...
\caption[Mesures de la duree de vie du neutron depuis 1962]{\textit{Duree de vie du Neutron d'apres Particle Data Group 2019} - Tracé historique\cite{Tanabashi}.} 
\label{fig:6:figure6}
\end{figure}
...
\caption[Courrier du rapport de Schatzman]{\textit{Courrier du rapport de Schatzman; Département d'Astrophysique Stellaire et Galactique : bref rapport sur la cosmologie de Francis M. Sanchez} - Date 9 Nov 2000.} 
...
\caption[Schema du Cosmos Biocentrique $H_2O$ ]{\textit{Schema du cosmos biocentrique autour de $H_2O$} - Non date.} 
...
\caption[Accuse reception du depot du compte-rendu aupres de l'Academie des Sciences]{\textit{Accuse reception du compte-rendu intitulé ``Le Grandcosmos Holophysique'' déposé aupres de l'Académie des Sciences par l'intermédiaire de l'institut de France} - Date au 03 DEC 2001.} 
...
\caption[Rapport de Kilmister]{\textit{Rapport de Clive Kilmister} -  Date au 1998.} 
