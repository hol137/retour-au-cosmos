...
C'est ainsi que l'école russe produisit des hologrammes qui battirent à plate couture les hologrammes américains et européens. En effet il suffisait d'un simple spot pour restituer l'image alors que les autres nécessitaient une lampe spectrale puissante, voir meme un laser pour les plus grands modèles.
