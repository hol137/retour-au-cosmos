...
L'holographie est la maitrise de l'information ondulatoire, par une technique en retard sur son époque. Elle n'est apparue qu'en 1948, alors qu'elle procède d'une idée simpliste, l'application de la modulation de fréquence de la radiophonie à toute les ondes, dont la lumière n'est qu'un cas particulier. C'est en effet sur les ondes électroniques que l'idée à germée dans l'esprit de Dennis Gabor, alors qu'il était assis dans un parc. Confronté au problème délicat du microscope électronique, où les lentilles électroniques sont de très mauvaise qualité, il s'est posé a question : peut-on faire de l'imagerie sans lentilles ?
...
Le développement de l'intelligence artificiele conduira à la traduction simultanée des quelqques 3000 langues actuelles dans le monde. C'en sera fini de l'égémonie scientifique des USA.
Les sciences actuelles, quifonctonnent sur le modèle américain, vont s'effondrer. 
...
\bibitem{Grosmann2} Michel H. Grosmann and Rebordão, José and Meyrueis, Patrick, 1985,02,p761--765,Propagation Of Waves In Optical Systems: Reformulation Of Huyghens Principle For Aspheric Systems,
...
\newblock {\em SPIE Ed.}, 2001. https://spie.org/Publications/Book/436130?SSO=1
\end{thebibliography}
\end{document}
