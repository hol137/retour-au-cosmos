...
\caption [Cours d'holographie à l'Institut d'Optique d'Orsay]{\textit{Cours d'holographie à l'Institut d'Optique d'Orsay fin des annees 1980}, with unit length the Electron Compton reduced wavelength. 
