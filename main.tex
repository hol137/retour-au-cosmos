...
Un débat portant sur le \textit{nombre de constantes fondamentales} a opposé récemment trois théoriciens, qui ont identifiés ce nombre avec le nombres d'entités indépendante (masse, longuer, temps, ...?). 
...
L'holographie est la maitrise de l'information ondulatoire, par une technique en retard sur son époque. L'idee provient initialement de Mieczysław Wolfke des 1920 \cite{Gabor}. Elle n'est apparue qu'en 1948, alors qu'elle procède d'une idée simpliste, l'application de la modulation de fréquence de la radiophonie à toute les ondes, dont la lumière n'est qu'un cas particulier. C'est en effet sur les ondes électroniques que l'idée à germée dans l'esprit de Dennis Gabor, alors qu'il était assis dans un parc. Confronté au problème délicat du microscope électronique, où les lentilles électroniques sont de très mauvaise qualité, il s'est posé a question : peut-on faire de l'imagerie sans lentilles ?

Poser la question appelait la réponse immédiate : il suffit de disposer d'une onde cohérente, comme en radiophonie. Cela anticipait le laser, voir ci-dessous.

Mais la dimension de l'image est définie par la longueur d'onde. Gabor proposa alors d'agrandir la photo pout pouvoir effectuer la lecture dans le visible, produisant un agrandissement de l'image dans le raport des longueurs d'onde. C'est le Principe de Gabor, qu'il ne faut pas confondre avec l'holographie, qui est toujours à l'echelle 1. C'est en appliquant ce principe de Gabor du'on peut définir l'interactipn électrique ou gravitationnelle, conduisant aux masses du photon et du graviton.

En effectuent des hologrammes le russe Deniziuk s'est apperçu qu'il avait enegistré sans le vouloir le support de la plaque photo, dont l'image apparaissait en lumière banche. Cela résulte d'un effet d'épaisseur de l'émulson photographique, qui enregistre un multi-hologramme ayant l'effet de sélectionner, en plus de l'information transverse, également l'information axiale, la longueur d'onde d'enregistrement. C'est pourquoi on peut voir l'image en lumière blanche car l'hologramme épais filtre la longueur d'onde.C'est le principe des filtres interférentiels. Cet effet avait été mis en évidence par Gabriel Lippman (Nobel 1908) dans son procédé où un bain de mercure permettait un contact étroit avec l'émulsion, et enregistrait donc la \textit{vraie couleur}, inaccessible en photographie classique. 
...
Le prédécesseur naturel du laser, le maser, fut découvert par Townes en 1954, qui les baptisa ainsi. L'initiale m signifiant 'micro-onde', tandis que le l de « laser » vient de l'anglais « light » qui signifie lumière. Les autres lettres viennent de « Amplified by Stimulated Emission of Radiation ». 
...
Mais, contrairement au triage magnétique de Townes dans le maser, Arthur Kastler obtint cette inversion de population par un moyen beaucoup plus général, le pompage optique,  C'est ce qu'a pu apprécier Townes, en 1956, lors de son année sabbatique  chez Kastler, à l'ENS de Paris. Dés 1958, il publia l'article de base sur le laser, notamment l'utilisation de deux miroirs comme cavité ultra-simple. En 1960, il déposait le brevet du laser, et la même année, Maiman bricolait un flash de photographie autour d'un barreau de rubis, dont les faces avaient été légèrement métallisées. Personne n'a cru que le premier laser était né, et son article fut refusé. 
...
\item Nombrologie (néologisme). Etude directe des relations entre les nombres cosmiques. S'oppose à la tr-s répandue "numérologie" qui cherche des relations sur des nombtes arbitraires.
...
\bibitem{Sanchez4} Francis M. Sanchez ``Holic Principle: The coherence of the Universe`` (Sept 1995), Entelechies, 16th ANPA, 324--344.
...
\bibitem{Grosmann2} Michel H. Grosmann, José Rebordão,  and Patrick Meyrueis, 1985,02,p761--765,Propagation Of Waves In Optical Systems: Reformulation Of Huyghens Principle For Aspheric Systems,
