...
\caption [Mesure de la duree de vie du neutron]{\textit{Duree de vie du Neutron d'apres Particle Data Group 2019} - Plot historique.} 
\label{fig:6:figure6}
\end{figure}
...
\centering
\includegraphics[width=14.5cm,height=8.6cm]{./figures/neutron-lifetime-pdg.png}
\caption [Mesure de la masse du Tau]{\textit{Mesure de la masse du Tau d'apres Particle Data Group 2019} - Plot historique.} 
\label{fig:7:figure7}
\end{figure}
