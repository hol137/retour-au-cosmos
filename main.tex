...
L'holographie est la maitrise de l'information ondulatoire, par une technique en retard sur son époque. L'idee provient initialement de Mieczysław Wolfke dés 1920 \cite{Gabor}. Elle n'est apparue qu'en 1948, alors qu'elle procède d'une idée simpliste, l'application de la modulation de fréquence de la radiophonie à toute les ondes, dont la lumière n'est qu'un cas particulier. C'est en effet sur les ondes électroniques que l'idée a germée dans l'esprit de Dennis Gabor, alors qu'il était assis dans un parc. Confronté au problème délicat du microscope électronique, où les lentilles électroniques sont de très mauvaise qualité, il s'est posé a question : peut-on faire de l'imagerie sans lentilles ?
