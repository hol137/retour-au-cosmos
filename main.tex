...
\caption[Interprétation holographique de la relation centrale. Collège de France, Février 2004]
...
\caption[Réunion à l'observatoire de Criméee]{\textit{La conference de l'ANPA a Cambridge: 1er rang de droite a gauche: Francis Sanchez, Christian Bozouard, oya artun, Valery Kotov. 2ieme rang à droite ... directeur de l'Observatoire de Munch}
\label{fig:11:figure11}
\end{figure}
...
\caption [Rapport de Fabrice Tardif sur l'holographie à balayage, décembre 1987] 
\label{fig:17:figure17}
\end{figure}
