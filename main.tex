...
\begin{figure}
\centering
\includegraphics[width=14.5cm,height=8.6cm]{./figures/neutron-lifetime-pdg.png}
\caption [Mesures de la duree de vie du neutron depuis ]{\textit{Duree de vie du Neutron d'apres Particle Data Group 2019} - Plot historique.} 
\label{fig:6:figure6}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=14.5cm,height=8.6cm]{./figures/tau-mass-pdg.png}
\caption [Mesures de la masse du Tau depuis]{\textit{Mesure de la masse du Tau d'apres Particle Data Group 2019} - Plot historique.} 
\label{fig:7:figure7}
\end{figure}
