...
\subsubsection{le nombre des grandeurs fondamentales}

Un débat a opposé récemment trois théoriciens, 

Le russe Okun défend la position conforme au sens commun, il n'y a que trois grandeurs fondamentales: la masse, la longueur et la durée, la célèbre trilogie M,L,T. 


Heureusement, pour la plupart des physiciens normaux,
Mais certains théoriciens, comme Planck, ajoutent un facteur de conversion entre Energie et température., la pseudo-cosntante de Boltzmann, qui , loin d'être une constnate cosmique n'est qu'un convertisseur d'unité Energie-Température. Bien qu'elle figure sur sa tombe de Boltzman, elle n'a rien de fondamental, elle dépend de la définition du Kelvin, donc de certaines propriétés de l'eau. 
...
Diffractogramme
Il est bon de rappeler que les photographies interferentielles de Gabriel Lippmann (Nobel 1908) sont a l'origine des techniques d'enregistrements holographiques. En effet la technique decrite par Lippmann dans xyz a servi de modelea D.Gabor.
