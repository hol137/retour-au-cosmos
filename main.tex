...
Pecker va même va jusqu'à critiquer le concept de symétrie, rejetant ainsi la physique des particules. Mais Il a oublié de mentionner dans l'extrait ci-dessus un concept qu'il a détesté tout particulièrement : celui d'analogie.
...
\subsection{L'harmonie numérique musicale et les constantes $e$ et $\pi$}

\subsection{Le neutron dans le $\pi$}

\subsection{Le nombre hiérarchique dans la base $e$}
